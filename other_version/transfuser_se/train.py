...
from model import TransFuserSE
...
parser.add_argument('--id', type=str, default='transfuser_se', help='Unique experiment identifier.')
...
# Model
model = TransFuserSE(config, args.device)
