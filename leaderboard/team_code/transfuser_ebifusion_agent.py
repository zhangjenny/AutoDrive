...
from transfuser_ebifusion.model import TransFuserEBiFusion
from transfuser_ebifusion.config import GlobalConfig
from transfuser_ebifusion.data import scale_and_crop_image, lidar_to_histogram_features, transform_2d_points
...
def get_entry_point():
	return 'TransFuserEBiFusionAgent'


class TransFuserEBiFusionAgent(autonomous_agent.AutonomousAgent):
	def setup(self, path_to_conf_file):
		...
		self.net = TransFuserEBiFusion(self.config, 'cuda')
