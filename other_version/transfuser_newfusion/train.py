...
from model import TransFuserNewFusion
...
parser.add_argument('--id', type=str, default='transfuser-newfusion', help='Unique experiment identifier.')
...
# Model
model = TransFuserNewFusion(config, args.device)
