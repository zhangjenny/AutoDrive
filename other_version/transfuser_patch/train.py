...
from model import TransFuserPatch
...
parser.add_argument('--id', type=str, default='transfuser_patch', help='Unique experiment identifier.')
...
# Model
model = TransFuserPatch(config, args.device)
