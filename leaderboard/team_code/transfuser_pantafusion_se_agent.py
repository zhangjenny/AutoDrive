...
from transfuser_pentafusion_se.model import TransFuserPentaFusionSE
from transfuser_pentafusion_se.config import GlobalConfig
from transfuser_pentafusion_se.data import scale_and_crop_image, lidar_to_histogram_features, transform_2d_points
...
def get_entry_point():
	return 'TransFuserPentaFusionSEAgent'


class TransFuserPentaFusionSEAgent(autonomous_agent.AutonomousAgent):
	def setup(self, path_to_conf_file):
		...
		self.net = TransFuserPentaFusionSE(self.config, 'cuda')
