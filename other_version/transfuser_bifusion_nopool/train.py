...
from model import TransFuserBiFusionNoPool
...
parser.add_argument('--id', type=str, default='transfuser_bifusion_nopool', help='Unique experiment identifier.')
...
# Model
model = TransFuserBiFusionNoPool(config, args.device)
