...
from transfuser_pentafusion.model import TransFuserPentaFusion
from transfuser_pentafusion.config import GlobalConfig
from transfuser_pentafusion.data import scale_and_crop_image, lidar_to_histogram_features, transform_2d_points
...
def get_entry_point():
	return 'TransFuserPentaFusionAgent'


class TransFuserPentaFusionAgent(autonomous_agent.AutonomousAgent):
	def setup(self, path_to_conf_file):
		...
		self.net = TransFuserPentaFusion(self.config, 'cuda')
