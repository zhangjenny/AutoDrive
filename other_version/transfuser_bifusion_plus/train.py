...
from model import TransFuserBiFusionPlus
...
parser.add_argument('--id', type=str, default='transfuser_bifusion_plus', help='Unique experiment identifier.')
...
# Model
model = TransFuserBiFusionPlus(config, args.device)
