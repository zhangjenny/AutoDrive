...
from model import TransFuserPentaFusionSE
...
parser.add_argument('--id', type=str, default='transfuser_pentafusion_se', help='Unique experiment identifier.')
...
# Model
model = TransFuserPentaFusionSE(config, args.device)
