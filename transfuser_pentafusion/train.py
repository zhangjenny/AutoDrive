...
from model import TransFuserPentaFusion
...
parser.add_argument('--id', type=str, default='transfuser_pentafusion', help='Unique experiment identifier.')
...
# Model
model = TransFuserPentaFusion(config, args.device)
