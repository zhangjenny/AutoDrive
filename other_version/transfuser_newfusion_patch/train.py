...
from model import TransFuserNewFusionPatch
...
parser.add_argument('--id', type=str, default='transfuser_newfusion_patch', help='Unique experiment identifier.')
...
# Model
model = TransFuserNewFusionPatch(config, args.device)
