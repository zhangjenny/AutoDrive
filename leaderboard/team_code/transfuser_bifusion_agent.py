...
from transfuser_bifusion.model import TransFuserBiFusion
from transfuser_bifusion.config import GlobalConfig
from transfuser_bifusion.data import scale_and_crop_image, lidar_to_histogram_features, transform_2d_points
...
def get_entry_point():
	return 'TransFuserBiFusionAgent'


class TransFuserBiFusionAgent(autonomous_agent.AutonomousAgent):
	def setup(self, path_to_conf_file):
		...
		self.net = TransFuserBiFusion(self.config, 'cuda')
