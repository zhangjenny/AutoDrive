...
from transfuser_pentafusion_epool.model import TransFuserPentaFusionEPool
from transfuser_pentafusion_epool.config import GlobalConfig
from transfuser_pentafusion_epool.data import scale_and_crop_image, lidar_to_histogram_features, transform_2d_points
...
def get_entry_point():
	return 'TransFuserPentaFusionEPoolAgent'


class TransFuserPentaFusionEPoolAgent(autonomous_agent.AutonomousAgent):
	def setup(self, path_to_conf_file):
		...
		self.net = TransFuserPentaFusionEPool(self.config, 'cuda')
