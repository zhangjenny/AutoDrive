...
from model import TransFuserEBiFusionNoPool
...
parser.add_argument('--id', type=str, default='transfuser_ebifusion_nopool', help='Unique experiment identifier.')
...
# Model
model = TransFuserEBiFusionNoPool(config, args.device)
