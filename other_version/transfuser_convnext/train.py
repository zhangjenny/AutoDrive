...
from model import TransFuserConvnext
...
parser.add_argument('--id', type=str, default='transfuser-convnext', help='Unique experiment identifier.')
...
# Model
model = TransFuserConvnext(config, args.device)
